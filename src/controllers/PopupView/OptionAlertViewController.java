 ...
 */
public class OptionAlertViewController extends AbstractPopupViewController {
    ...
    public OptionAlertViewController(Parent parent, String title, String body, String btn1text, EventHandler<ActionEvent> btn1, String btn2text, EventHandler<ActionEvent> btn2) {
        ...
        button1.setText(btn1text.toUpperCase());
        button2.setText(btn2text.toUpperCase());
        button1.setOnAction(btn1);
