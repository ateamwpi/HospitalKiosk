...
public class PathfindingTests {
    ...
    public void testAStar1() {
        ...
        Node n1 = new Node(1, 1, 1, "NONE");
        Node n2 = new Node(2, 2, 2, "NONE");
        Node n3 = new Node(3, 3, 3, "NONE");
        n1.addConnection(n2);
        n2.addConnection(n3);
        n.put(1, n1);
        n.put(2, n2);
    ...
    public void testAStar2() {
        HashMap<Integer, Node> n = new HashMap<Integer, Node>();
        Node n1  = new Node(1,  1, 1, "NONE");
        Node n2  = new Node(2,  1, 2, "NONE");
        Node n3  = new Node(3,  1, 3, "NONE");
        Node n4  = new Node(4,  1, 4, "NONE");
        Node n5  = new Node(5,  2, 5, "NONE");
        Node n6  = new Node(6,  3, 6, "NONE");
        Node n7  = new Node(7,  4, 7, "NONE");
        Node n8  = new Node(8,  5, 7, "NONE");
        Node n9  = new Node(9,  6, 7, "NONE");
        Node n10 = new Node(10, 2, 3, "NONE");
        Node n11 = new Node(11, 3, 3, "NONE");
        Node n12 = new Node(12, 7, 7, "NONE");
        Node n13 = new Node(13, 3, 4, "NONE");
        Node n14 = new Node(14, 3, 5, "NONE");
        Node n15 = new Node(15, 3, 7, "NONE");
        Node n16 = new Node(16, 2, 7, "NONE");
        Node n17 = new Node(17, 6, 6, "NONE");
        Node n18 = new Node(18, 5, 5, "NONE");
        Node n19 = new Node(19, 5, 4, "NONE");
        Node n20 = new Node(20, 6, 2, "NONE");
        Node n21 = new Node(21, 4, 2, "NONE");
        Node n22 = new Node(22, 5, 1, "NONE");
        Node n23 = new Node(23, 6, 4, "NONE");
        Node n24 = new Node(24, 6, 2, "NONE");
        Node n25 = new Node(25, 5, 2, "NONE");
